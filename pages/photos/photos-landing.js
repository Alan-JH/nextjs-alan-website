...
export default function FirstPost() {
  ...
  return (
    <Layout layout_type={styles.container} bgimage = "/images/headers/photographyheader.jpg" pagetitle = "Photos" headertextcolor = "white">
      ...
      Toma M-900 point and shoot, and an ancient Carl-Zeiss from before SLRs were a thing. Unfortunately it appears that all the cameras don't have working electronics, except the N65, which I don't
      have the batteries to test right now. The FX-7 has a mechanical shutter, which still works, but the light meter is broken. I may try to fix some of these in the future.
